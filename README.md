...
Runs weekly and can also be started manually. It executes `scripts/backfill_short.py` and updates short-range model skill from archived model runs.

### `validate.yml`

Runs on pushes and pull requests. It checks JavaScript syntax, both Python collectors, JSON validity, and key app references.
