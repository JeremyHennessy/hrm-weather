(()=>{
  ...
  const defs=`<defs>
    ...
    <linearGradient id="wcMoon" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#fff9d6"/><stop offset="1" stop-color="#d9e4f2"/></linearGradient>
    ...
    <mask id="wcMoonMask"><rect width="64" height="64" fill="#fff"/><circle cx="40" cy="22" r="18" fill="#000"/></mask>
  ...
  const moonShape=()=>`<circle cx="29" cy="29" r="19" fill="url(#wcMoon)" mask="url(#wcMoonMask)" filter="url(#wcShadow)"/>`;
  ...
  function moon(){return svg(`${moonShape()}<g fill="#eaf3ff" opacity=".75"><circle cx="49" cy="12" r="1.1"/><circle cx="53" cy="25" r="1.4"/><circle cx="43" cy="7" r=".8"/></g>`)}
  ...
  function nightPartly(){return svg(`<g transform="translate(-5 -5) scale(.78)">${moonShape()}</g>${cloudShape()}`)}
  ...
  function nightShowers(){return svg(`<g transform="translate(-7 -7) scale(.70)">${moonShape()}</g>${cloudShape('url(#wcCloudDark)')}<g stroke="url(#wcRain)" stroke-width="3" stroke-linecap="round"><path d="M26 49l-3 7M40 49l-3 7"/></g>`)}
