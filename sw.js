const CACHE='weather-consensus-v12';
const ASSETS=['./','./index.html','./app.html','./v4.css','./v5b.js','./v6-extra.js','./v7-final.js','./v8-ui.js','./manifest.webmanifest','./icons/weather-consensus.svg'];
