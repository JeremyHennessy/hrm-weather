const CACHE='weather-consensus-v14';
const ASSETS=['./','./index.html','./app.html','./v4.css','./v9-modern.css','./v10-reference.css','./v5b.js','./v6-extra.js','./v7-final.js','./v8-ui.js','./v10-layout.js','./manifest.webmanifest','./icons/weather-consensus.svg','./icons/apple-touch-icon.png'];
